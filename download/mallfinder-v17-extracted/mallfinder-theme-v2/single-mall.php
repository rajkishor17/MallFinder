    ...
    <div class="amenities-section">
        ...
        <div class="amenities-grid">
            ...
            $amenity_icons = array(
                ...
                'free_parking' => '<path d="M12.79 3L8 11.17V21h8v-9.83L12.21 3zm-.79 15c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/>',
                ...
                'cafe' => '<path d="M18.5 3H6c-1.1 0-2 .9-2 2v5.71c0 3.83 2.95 7.18 6.78 7.29 3.96.12 7.22-3.06 7.22-7v-1h.5c1.93 0 3.5-1.57 3.5-3.5S20.43 3 18.5 3zM16 5v3h-2V5h2zm-4 0v3H8V5h4zM6 5v3h-.5c-.18 0-.34.02-.5.05V5h1zm12.5 4H18V8h.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5zM6 19h12v2H6z"/>',
                ...
                'outdoor_seating' => '<path d="M9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2zm2-7h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"/>',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (storeSearchInput && storeList) {
        ...
        if (storeSearchBtn) {
            storeSearchBtn.addEventListener('click', filterStores);
        }
