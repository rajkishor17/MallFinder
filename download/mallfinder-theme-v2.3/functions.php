...
function mallfinder_settings_page_html() {
    ...
    ?>
    <style>
    .mallfinder-settings-tabs {
        margin: 20px 0;
    }
    .mallfinder-settings-tabs .nav-tab {
        margin-bottom: 0;
    }
    .mallfinder-tab-content {
        background: #fff;
        padding: 20px;
    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper mallfinder-settings-tabs">
        ...
        <form method="post" action="options.php">
            ...
            <div id="general-settings" class="mallfinder-tab-content">
            ...
            <div id="left-sidebar-settings" class="mallfinder-tab-content" style="display:none;">
            ...
            <div id="right-sidebar-settings" class="mallfinder-tab-content" style="display:none;">
            ...
            <div id="header-ad-settings" class="mallfinder-tab-content" style="display:none;">
            ...
            <div id="footer-ad-settings" class="mallfinder-tab-content" style="display:none;">
