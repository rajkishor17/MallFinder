                ...
                ?>
                    <div class="header-social">
                        <?php if (!empty($social['facebook'])) : ?>
                            <a href="<?php echo esc_url($social['facebook']); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Follow us on Facebook', 'mallfinder'); ?>" class="icon-facebook">
                        ...
                        <?php if (!empty($social['twitter'])) : ?>
                            <a href="<?php echo esc_url($social['twitter']); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Follow us on X', 'mallfinder'); ?>" class="icon-twitter">
                        ...
                        <?php if (!empty($social['instagram'])) : ?>
                            <a href="<?php echo esc_url($social['instagram']); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Follow us on Instagram', 'mallfinder'); ?>" class="icon-instagram">
                        ...
                        <?php if (!empty($social['linkedin'])) : ?>
                            <a href="<?php echo esc_url($social['linkedin']); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Connect on LinkedIn', 'mallfinder'); ?>" class="icon-linkedin">
                        ...
                        <?php if (!empty($social['youtube'])) : ?>
                            <a href="<?php echo esc_url($social['youtube']); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Subscribe on YouTube', 'mallfinder'); ?>" class="icon-youtube">
                        ...
                        <?php if (!empty($social['whatsapp'])) : ?>
                            <a href="https://wa.me/<?php echo esc_attr(preg_replace('/[^0-9]/', '', $social['whatsapp'])); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Chat on WhatsApp', 'mallfinder'); ?>" class="icon-whatsapp">
